...
# MDDtrainuse11<-MDDtrain_class[MDDtrain_class$group==1,]
# MDDtrainuse12<-MDDtrain_class[MDDtrain_class$group==0,]
# choose=sample(1:nrow(MDDtrainuse11), nrow(MDDtrainuse12), replace = FALSE)
# MDDtrainuse11<-MDDtrainuse11[choose,]
# MDDtrainuse<-rbind(MDDtrainuse11,MDDtrainuse12)
# # MDDtrain_class<-data.frame(MDDtrainuse$group,MDDtrainuse$gender,MDDtrainuse$studygroup,row.names = MDDtrainuse$name)
# # colnames(MDDtrain_class)<-c("outcome","gender","studygroup")
# MDDtrain_class<-data.frame(MDDtrainuse$group,row.names = MDDtrainuse$name)
# colnames(MDDtrain_class)<-c("outcome")
...
MDDtest <- read.csv("MDDtest_expr_combat.csv", row.names = 1,check.names = F,stringsAsFactors = F)
...
MDDtest_class<-data.frame("GSE39653+GSE52790",MDDtest_class$group,MDDtest_class$batch,row.names = MDDtest_class$name)
colnames(MDDtest_class)<-c("Cohort","outcome","source")
# MDDtest_class<-data.frame(MDDtest_class$batch,MDDtest_class$group,row.names = MDDtest_class$name)
# colnames(MDDtest_class)<-c("Cohort","outcome")
...
#clss<-read.table( "C:/Users/sunshiny/Downloads/SLEMDD/MDD/model/InputData/example/Testing_class.txt", header = T, sep = "\t", row.names = 1,check.names = F,stringsAsFactors = F)
...
# code.path="C:/Users/sunshiny/Downloads/SLEMDD/MDD/model/Codes"
# data.path="C:/Users/sunshiny/Downloads/SLEMDD/MDD/model/InputData/example/"
# res.path="C:/Users/sunshiny/Downloads/SLEMDD/MDD/model/InputData/example/"
